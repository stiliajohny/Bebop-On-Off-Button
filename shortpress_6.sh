#! /bin/sh
# This script deletes your media files if they have previously been copied to a USB stick # Red LED = script starts
...
# delete the files
echo "Deleting contents of media directory" # Orange LED flashing during deletion (BLDC_Test_Bench -G 1 1 1 >/dev/null) &
